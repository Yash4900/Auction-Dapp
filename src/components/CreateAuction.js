            ...
            <div id="create-form">
              <form className="f14" onSubmit={this.handleSubmit} encType="multipart/form-data">
                <div className="form-group my-3">
                  ...
                  <input type="text" className="form-control form-control-sm bg-light" id="name" placeholder="Enter item name" onChange={this.handleFieldChange} />
                </div>
                <div className="form-group my-3">
                ...
                <div className="form-group my-3">
                  <div className="row">
                    <div className="col">
                      ...
                      <input type="text" className="form-control form-control-sm bg-light" id="baseprice" placeholder="Enter base amount" onChange={this.handleFieldChange} />
                    </div>
                    <div className="col">
                      <label for="incrementby">Increment bid by</label>
                      <input type="text" className="form-control form-control-sm bg-light" id="incrementby" placeholder="Enter amount" onChange={this.handleFieldChange} />
                    </div>
                  </div>
                </div>
                <div className="form-group my-3">
                  ...
                  <br />
                  <input type="datetime-local" className="form-control form-control-sm bg-light" id="deadline" name="deadline" onChange={this.handleFieldChange} />
                </div>
